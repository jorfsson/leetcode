...
parser.add_argument('--completed', action='store', dest='completed', choices=PROBLEMS)
parser.add_argument('--get-problem', action='store_true', dest='get_problem')
parser.add_argument('--get-count', action='store', dest='get_count', choices=PROBLEMS)
...
def main():
    with open(data_uri/'problems.json', 'r+') as jsonfile:
        ...
        match True:
            ...
            case args.get_problem:
                leetcode.get_random_problem()
            case args.completed:
                leetcode.increment_count
            case _:
